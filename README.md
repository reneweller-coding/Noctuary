...
**[Noctuary-2.1.0-Setup.exe](https://github.com/reneweller-coding/Noctuary/releases/download/v2.1.0/Noctuary-2.1.0-Setup.exe)**
...
**[portable zip](https://github.com/reneweller-coding/Noctuary/releases/download/v2.1.0/Noctuary-2.1.0-portable.zip)**
for anyone who would rather not run an installer, and a
**[manual](https://github.com/reneweller-coding/Noctuary/releases/download/v2.1.0/Noctuary-Manual.pdf)**
