...
**[Noctuary-2.0.2-Setup.exe](https://github.com/reneweller-coding/Noctuary/releases/download/v2.0.2/Noctuary-2.0.2-Setup.exe)**
...
**[portable zip](https://github.com/reneweller-coding/Noctuary/releases/download/v2.0.2/Noctuary-2.0.2-portable.zip)**
for anyone who would rather not run an installer, and a
**[manual](https://github.com/reneweller-coding/Noctuary/releases/download/v2.0.2/Noctuary-Manual.pdf)**
